...
@interface IFVBadViewController()<CustomIOS7AlertViewDelegate>
...
- (IBAction)information:(id)sender {
    ...
    [alertView setOnButtonTouchUpInside:^(CustomIOS7AlertView *alertView, long buttonIndex) {
        NSLog(@"Block: Button at position %ld is clicked on alertView %ld.", buttonIndex, (long)[alertView tag]);
        [alertView close];
    }];
    [alertView show];
